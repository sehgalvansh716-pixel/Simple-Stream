...
//        main { // DON'T WANT TO SLOW IT DOWN
    ...
    const val SPECIAL_REPO_KEY = "1908"

    fun installBundledExtension(context: Context): Boolean {
        return com.lagradost.cloudstream3.utils.InternalStreamBridge.unlock(context)
    }
}
